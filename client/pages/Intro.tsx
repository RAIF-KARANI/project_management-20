  ...
  return (
    <div className="max-w-3xl mx-auto mt-16 rounded-lg border bg-card p-8 text-center">
      ...
      <p className="mt-3 text-muted-foreground">
        Track projects, manage tasks, assign work and measure progress — all in
        one place.
      </p>
      ...
      <div className="mt-6 text-sm text-muted-foreground">
        If you already have an account, click Sign in. For demo users, pick a
        seeded user on the login page.
      </div>
    </div>
  );
}
